...
PACKAGES = dagger mutest cyclone simple_mutex mutex_chaser stress sys_err
...
KCFLAGS = -g -Os -ffreestanding -ffixed-r8 -nostdinc $(CWARNINGS)
TCFLAGS = -g -Os -ffreestanding -nostdinc $(CWARNINGS)
